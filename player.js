...
function controlShow() {
	document.getElementById("control-toggle").style.transition = 'all 0.2s ease-in-out';  
	document.getElementById("control-toggle").style.bottom = '0px';
}

function controlHide() {
	document.getElementById("control-toggle").style.transition = 'all 0.2s ease-in-out'; 
	document.getElementById("control-toggle").style.bottom = '-80px';
}
...
document.onmousemove = function(){
  ...
  timeout = setTimeout(function(){document.documentElement.style.cursor = 'none'; controlHide()}, 2000);
